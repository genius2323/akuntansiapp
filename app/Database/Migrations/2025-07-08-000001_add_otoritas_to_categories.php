...
class AddOtoritasToCategories extends Migration
{
    public function up()
    {
        $fields = [
        ...
        $forge2->addColumn('categories', $fields);
    }

    public function down()
    {
        $this->forge->dropColumn('categories', 'otoritas');

        $db2 = \Config\Database::connect('db1');
        $forge2 = \Config\Services::forge($db2);
        $forge2->dropColumn('categories', 'otoritas');
    }
}
