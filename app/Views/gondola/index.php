...
<section class="content">
    <div class="container-fluid">        
        ...
        <div class="card">
            <div class="card-body">
                <a href="<?= site_url('gondola/create') ?>" class="btn btn-primary mb-3">Tambah Gondola</a>
                    ...
                    <tbody>
                        <?php foreach ($gondolas as $row): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= site_url('gondola/' . $row['id'] . '/edit') ?>" class="btn btn-sm btn-warning">Edit</a>
                                    <form action="<?= site_url('gondola/' . $row['id']) ?>" method="post" style="display:inline-block;">
