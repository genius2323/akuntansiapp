...
$klasifikasiMenus = [
    ...
    ['name' => 'Warna Sinar', 'slug' => 'warnasinar', 'icon' => 'fas fa-lightbulb', 'url' => site_url('warnasinar')],
    ['name' => 'Ukuran Barang', 'slug' => 'ukuranbarang', 'icon' => 'fas fa-expand-arrows-alt', 'url' => site_url('ukuranbarang')],
    ...
    ['name' => 'Warna Body', 'slug' => 'warnabody', 'icon' => 'fas fa-palette', 'url' => site_url('warnabody')],
    ['name' => 'Warna Bibir', 'slug' => 'warnabibir', 'icon' => 'fas fa-tint', 'url' => site_url('warnabibir')],
